...
# Logging
# IMPORTANT: Always use server system time, never client time
# {asctime} is formatted by the Formatter using the server's locale and timezone
# All timestamps in logs are automatically in the server's local time
LOGGING = {
    "version": 1,
    ...
    "formatters": {
        "verbose": {
            ...
            "style": "{",
            "datefmt": "%Y-%m-%d %H:%M:%S",  # Server system time format
        },
    },
    "handlers": {
        "console": {
