...
class DailyOrderAPITest(TestCase):
    ...
    def test_create_order(self):
        ...
        self.assertEqual(DailyOrder.objects.get().data['breakfast']['menuCounts']['A'], 1)
    ...
    def test_get_by_date(self):
        # Create order
        DailyOrder.objects.create(user=self.user, date=self.today, data={'key': 'value'})
