    ...
    const fetchUsers = useCallback(async () => {
        try {
            ...
            if (res.ok) {
                ...
                setUsers(list.filter((u: AdUser) => !u.is_staff));
            } else {
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm text-gray-600">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {loading ? (
                                <tr>
                                    <td colSpan={3} className="px-6 py-8 text-center text-gray-400">Načítavam klientov...</td>
                                </tr>
                            ) : filteredUsers.length === 0 ? (
                                <tr>
                                    <td colSpan={3} className="px-6 py-8 text-center text-gray-400">Žiadni klienti</td>
                                </tr>
                            ) : (
