...
const AdminUserDetail: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (!firstName.trim() || !lastName.trim() || !userEmail.trim()) {
                alert("Meno, priezvisko a email sú povinné údaje.");
                setSaving(false);
                return;
            }
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
            <div>
                <button onClick={() => navigate('/admin/roles')} className="text-gray-500 hover:text-gray-900 mb-4 flex items-center">
                    ← Späť na zoznam rolí
                </button>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-1 gap-6 mb-6">
                    ...
                    <div className="border-t border-gray-100 pt-6 mt-2">
                         <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700 mb-2">Rola v systéme</label>
                            ...
                            <p className="mt-2 text-sm text-gray-500">
                                <strong>Klient:</strong> Má prístup len k objednávaniu (ak je povolené). <br/>
                                <strong>Administrátor:</strong> Má prístup k tomuto admin panelu.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center mt-6">
                             <label className="relative inline-flex items-center cursor-pointer">
                                ...
                                <span className="ml-3 text-sm font-medium text-gray-900">Účet je aktívny</span>
                            </label>
                        </div>
                    </div>
                </div>
